...
public class PolyartGolemn : MonoBehaviour , ICharacterMovement
{
    ...
    public void WalkTowardPosition(Vector3 targerPosition)
    {
        ...
        transform.forward = newVector;
        transform.position += wanderingSpeed * Time.deltaTime * newVector.normalized;

    }

    private string[] animationArray = new string[3] {"GetHitTrigger","VictoryTrigger","Attack01Trigger"};
